  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Trabajo y reporte de incidentes.
        p.mb-4 Identificar conceptos clave para el manejo de accidentes de trabajo a partir del desarrollo de su oportuna investigación. 
